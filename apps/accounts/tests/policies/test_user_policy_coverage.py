...
class TestCanCreateUserCoverage:
    ...
    def test_usuario_sem_classificacao_nao_pode_criar_usuario(self, usuario_sem_role):
        """
    ...
    def test_operador_sem_classificacao_criacao_nao_pode_criar(self, operador_acao):
        """
...
class TestCanCreateUserInApplicationCoverage:
    ...
    def test_gestor_sem_role_na_app_alvo_retorna_false(self, gestor_pngi):
        """
    ...
    def test_gestor_com_role_na_app_alvo_retorna_true(self, gestor_pngi):
        """
    ...
    def test_usuario_sem_pode_criar_nao_pode_criar_em_app(self, operador_acao):
        """
...
class TestCanManageTargetUserCoverage:
    ...
    def test_operador_nao_pode_editar_target_user(self, operador_acao, gestor_pngi):
        policy = UserPolicy(user=operador_acao)
    ...
    def test_usuario_inativo_nao_pode_gerenciar(self, usuario_sem_role, gestor_pngi):
        """
