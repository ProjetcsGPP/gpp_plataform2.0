...
class TestCanViewUserrole:
    ...
    def test_portal_admin_can_view_any_userrole(self, monkeypatch, portal_admin_user, userrole_regular):
    ...
    def test_user_can_view_own_userrole(self, monkeypatch, regular_user, userrole_regular):
    ...
    def test_regular_user_cannot_view_other_userrole(self, monkeypatch, other_user, userrole_regular):
...
class TestCanCreateUserrole:
    ...
    def test_portal_admin_can_create_in_ready_unblocked_app(
        ...
        ur = make_userrole(user=portal_admin_user, aplicacao=app_ready, role=regular_role, user_id=50)
    ...
    def test_portal_admin_cannot_create_in_blocked_app(
        ...
        ur = make_userrole(user=portal_admin_user, aplicacao=app_blocked, role=regular_role, user_id=50)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
    ...
    def test_portal_admin_cannot_create_in_not_ready_app(
        ...
        ur = make_userrole(user=portal_admin_user, aplicacao=app_not_ready, role=regular_role, user_id=50)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
        assert policy.can_create_userrole() is False
    ...
    def test_portal_admin_cannot_assign_admin_role(
        ...
        ur = make_userrole(user=portal_admin_user, aplicacao=app_ready, role=admin_role, user_id=50)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
        assert policy.can_create_userrole() is False

    def test_superuser_can_assign_admin_role(self, superuser, app_ready, admin_role):
        ur = make_userrole(user=superuser, aplicacao=app_ready, role=admin_role, user_id=10)
    ...
    def test_regular_user_cannot_create_userrole(
        ...
        ur = make_userrole(user=regular_user, aplicacao=app_ready, role=regular_role, user_id=20)
...
class TestCanDeleteUserrole:
    ...
    def test_portal_admin_can_delete_userrole_of_other_user(
        ...
        ur = make_userrole(user=other_user, aplicacao=app_ready, role=regular_role, user_id=30)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
    ...
    def test_portal_admin_cannot_revoke_admin_role(
        ...
        ur = make_userrole(user=other_user, aplicacao=app_ready, role=admin_role, user_id=30)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
        assert policy.can_delete_userrole() is False
    ...
    def test_portal_admin_can_delete_userrole_even_in_blocked_app(
        ...
        ur = make_userrole(user=other_user, aplicacao=app_blocked, role=regular_role, user_id=30)
        policy = UserRolePolicy(portal_admin_user, ur)
        _patch_admin(monkeypatch, policy, True)
        assert policy.can_delete_userrole() is True
